...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_ENGRAM)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_ENGRAM
    #elif defined (MIRYOKU_ALPHAS_HALMAK)
...
#if !defined(MIRYOKU_LAYER_MAGIC)
  #define MIRYOKU_LAYER_MAGIC MIRYOKU_ALTERNATIVES_MAGIC
#endif
#if !defined(MIRYOKU_LAYERMAPPING_MAGIC)
